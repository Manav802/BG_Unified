export const TESTIMONIALS = [
    ...
    },
    {
        ...
        imageAlt: "Company Logo",
        author: "Tushar Bhat",
        paragraph: "BG Unified Solutions, I would like to thank BG Unified Solutions for the exception customer service they have provided to Optus. Their experts in different technologies like security, voice and a broad range of skills including F5 Load balancers, WAN Optimizatin, WAN , Cloud technologies and Cisco technologies have proven to be quite valuable to us. This has created high business efficiency for Optus, especially for voice/ video projects, WAN implementation, DC design. It has also proven to be cost effective and improve business results. Once again, thank you so much BG Unified Solution for your professional expertise and assistance.",
        CompanyName: "Network Engineer | Business Services Testing",
    },
...

    {
        ...
        imageAlt: "Company Logo",
        author: "Julian Evans",
        paragraph: "I worked with BG Unified Solutions briefly while scoping work for an upgrade to UCCX Premium. The team quoted on this work with an impressive turn-around time and provided an in-depth analysis of our network topology to facilitate a more effective discussion on project possibilities. From the start, they showed a huge level of technical knowledge and enthusiasm and I hope to have the opportunity to work with them in the future.",
        CompanyName: "JP Accelerated Outcomes for Volunteering and Charity Services",
    },
