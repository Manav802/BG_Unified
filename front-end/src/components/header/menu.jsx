...
function menu(props) {
    ...
    return (
        ...
        <div className="d-block d-lg-none">
            <Box as={IoIosMenu} size="32px" onClick={onOpen} className="hover-effect mr-3"></Box>
            <Drawer
                isOpen={isOpen}
                placement="left"
                onClose={onClose}
            ...
            <DrawerOverlay />
                ...
                <DrawerBody style={{overflowY:"auto"}}>
                    <Button className="btn-block btn my-2" bg="white" py="24px" onClick={handleToggle}>
                        <div className="d-flex justify-content-between align-items-center w-100">
                            <span className="display6">Services</span>
                            <Icon name={services ? "chevron-up" : "chevron-down"} size="16px"></Icon>
                        </div>
                    </Button>
                    <Collapse px="16px" mb={4} isOpen={services}>
                        <Services></Services>
                    </Collapse>
                    <Button className="btn-block btn my-2" bg="white" py="24px" onClick={handleToggle2}>
                        <div className="d-flex justify-content-between align-items-center w-100">
                            <span className="display6">Company</span>
                            <Icon name={company ? "chevron-up" : "chevron-down"} size="16px"></Icon>
                        </div>
                    </Button>
                    <Collapse px="16px" mb={4} className="footer-content" isOpen={company}>
