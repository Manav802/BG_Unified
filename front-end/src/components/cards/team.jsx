        ...
        <div>
            ...
            <div className="col d-flex p-4 flex-column">
                ...
                <div className="d-flex py-3">
                    <a className="mr-2" href="#"><Image as={AiFillBehanceCircle} h="24px" w="24px"></Image></a>
                    <a className="mr-2" href="#"><Image as={AiFillGithub} h="24px" w="24px"></Image></a>
                    <a className="mr-2" href="#"><Image as={AiFillLinkedin} h="24px" w="24px"></Image></a>
                </div>
            </div>
        </div>
     </div>
