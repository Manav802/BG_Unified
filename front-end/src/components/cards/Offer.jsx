...
function Offer(props) {
    ...
    return (
        <>
            {offer === "0" && <Box pos="fixed" width="100vw" zIndex="1000" bottom={[0,0, 4]} p={[0,0,2,8]}>
            <Container width="100%" maxW="1366px">
            <Fade duration={300} delay={3000} bottom distance="5%">

                <Flex direction={["column", "column", "row"]} pos="relative" align="center" bg="white" rounded={8} boxShadow="xl" py={[3, 4,12, 16]} px={[3, 4, 12,16]}>
                <Box rounded="50%" my={[2,2,4]} bg="light.400" p={[5,6,12]} >
                    <Box as={FaPercent} color="primary.500" size={["30px","36px","48px"]}></Box>
                </Box>
                <Box ml={[0,0,8]}>
                    <Title fontSize={["md", "lg","2xl"]} textAlign={["center", "center", "left"]}>We are delighted to offer free services* for the next 3 months to any business(s) related to the Health and Safety of Australians.</Title>
                    <Text m={2} fontSize={["xs", "md","lg"]} textAlign={["center", "center", "left"]} opacity=".7">No charges at all for the next three months. Let us help you if you have limited budgets and because of COVID your current infrastructure can't handle the load. Dial our direct line <a href="tel:+61290950000" className="link text-primary">+61 2 9095 0000</a>. We will get things in motion very quickly.</Text>
                </Box>
