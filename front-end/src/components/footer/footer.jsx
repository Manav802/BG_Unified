...
function footer(props) {
  return (
    <>
   <Section my={0} py={[2,4]} bg="black" color="white">
     <Container>
        <Flex mx={[2,2,0]} direction="column" alignItems="center">
            ...
            <Flex flexDirection="row" wrap="wrap" justify="center" mt={4} px={4}>
   ...
   <Box bg="black" color="white" py={3}>
     <Container>
       ...
       <Text textAlign={["center", "center", "left"]} my={[3,3,0]} width={["100%","100%",1/2]}>Website developed and maintained by <Link href="/webteam"><Button variant="unstyled" fontSize="md" as="a" color="primary">Peppershades</Button></Link></Text>
