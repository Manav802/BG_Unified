...
function main(props) {
    return (
            ...
            <Container>
                <Grid templateColumns={["100%","128px auto","192px auto","256px auto","40% 60%"]} p={[8,8,12]}>
                    ...
                    <Flex direction="column" justify="center" px={[3,5,12]}>
                        <a className="link"><Heading fontSize={["xl","xl","2xl","3xl"]} fontFamily="Nexa Bold">Free Services* for three months to Health and Safety related Businesses.<Icon name="chevron-right"></Icon></Heading></a>
        ...
        <SwiperSlide>
            <Container>
                <Grid templateColumns={["100%","128px auto","192px auto","256px auto","40% 60%"]} p={[8,8,12]}>
                    <Image alt="Free Healthcare Services" justifySelf="center" src="/assets/images/vectors/GPU_Offer-01.svg" padding={[4,0]}  width={["60%","100%"]}></Image>
                    <Flex direction="column" justify="center" px={[3,5,12]}>
                        <a className="link"><Heading fontSize={["xl","xl","2xl","3xl"]} fontFamily="Nexa Bold">BGUS is launching GPUaaS through multiple Geo-locations and with Bundled Solutions!!<Icon name="chevron-right"></Icon></Heading></a>
        ...
        <SwiperSlide>
            <Container>
                <Grid templateColumns={["100%","128px auto","192px auto","256px auto","40% 60%"]} p={[8,8,12]}>
                    <Image alt="Free Healthcare Services" justifySelf="center" src="/assets/images/vectors/SOC_Offer-01.svg" padding={[4,0]}  width={["60%","100%"]}></Image>
                    <Flex direction="column" justify="center" px={[3,5,12]}>
                        <a className="link"><Heading fontSize={["xl","xl","2xl","3xl"]} fontFamily="Nexa Bold">Entirely hosted SOCaaS within BGUS DC locations, supported with different technologies!!<Icon name="chevron-right"></Icon></Heading></a>
