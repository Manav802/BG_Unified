            ...
            <Container>
                <Grid templateColumns={["100%","128px auto","192px auto","256px auto","40% 60%"]} p={[8,8,12]}>
                    ...
                    <Flex direction="column" justify="center" px={[3,5,12]}>
                        <Heading fontSize={["xl","xl","2xl","3xl"]} fontFamily="Nexa Bold">Free Services* for 3 months for Healthy and Safety related Businesses. </Heading>
        ...
        <SwiperSlide>
            <Container>
                <Grid templateColumns={["100%","128px auto","192px auto","256px auto","40% 60%"]} p={[8,8,12]}>
                    ...
                    <Flex direction="column" justify="center" px={[3,5,12]}>
                        <Heading fontSize={["xl","xl","2xl","3xl"]} fontFamily="Nexa Bold">BGUS launching GPUaaS through multiple Geo-locations and with Bundled Solutions!!</Heading>
        ...
        <SwiperSlide>
            <Container>
                <Grid templateColumns={["100%","128px auto","192px auto","256px auto","40% 60%"]} p={[8,8,12]}>
                    ...
                    <Flex direction="column" justify="center" px={[3,5,12]}>
                       <Heading fontSize={["xl","xl","2xl","3xl"]} fontFamily="Nexa Bold">Completely hosted SOCaaS within BGUS DC locations, supported with different technologies!!</Heading>
