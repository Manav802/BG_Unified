    ...
    return (
        <div className="auth-modal shadow-sm col-lg-6 col-md-8 offset-lg-3 offset-md-2 rounded-top">
            ...
            <div className="mt-4 px-5 col">
                ...
                <PasswordInput placeholder="Confirm password" className="my-2"></PasswordInput>
                <Button className="btn-block mt-4 shadow" variantColor="primary" size="lg" >Sign Up</Button>
            </div>
        </div>
    );
}
