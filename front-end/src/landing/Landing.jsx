        ...
        return (
            <div className="landing">
                ...
                <div className="container-fluid">
                    <div className="row flex mt-5 py-lg-5 justify-content-center">
                        <div className="d-flex position-absolute justify-content-center overflow-hidden w-100" >
                            <svg  style={{width:svgWidth}} height="864.684" >
                                <defs>
                                    <clipPath id="clip-path">
                                    <path id="Path_266" data-name="Path 266" d="M-318.159-17.14l3840-91.457V715.5l-3840-184.812Z" transform="translate(318.159 2059)" fill="#051133"/>
                                    </clipPath>
                                </defs>
                                <g id="Group_233" data-name="Group 233" transform="translate(-5 -1950.403)">
                                    <g id="Group_232" data-name="Group 232">
                                    <path id="Path_267" data-name="Path 267" d="M-321.192,138.631l3840-247.228V301.028l-3840,455.058Z" transform="translate(323.192 2059)" fill="#f32222"/>
                                    <path id="Path_266-2" data-name="Path 266" d="M-318.159-17.14l3840-91.457V715.5l-3840-184.812Z" transform="translate(320.159 2059)" fill="#051133"/>
                                    </g>
                                    <g id="Mask_Group_31" data-name="Mask Group 31" clip-path="url(#clip-path)">
                                    <g id="Group_234" data-name="Group 234" transform="translate(-5.126 59)">
                                        <image id="Artboard_105_2x-100" data-name="Artboard 105@2x-100" width="750.128" height="562.752" transform={`translate(${svgWidth-800} 2100.307)`} href={icNeon} />
                                    </g>
                                    </g>
                                </g>
                            </svg>
                ...
                <div className="container landing-benefits">
                    <div className="row forth">
                    <div className="col-12 features text-center text-uppercase">
                        Features
                    </div>
