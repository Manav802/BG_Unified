          ...
          <div className="row">
            <div className="col-lg-10 text-center offset-lg-1">
              ...
              <div className="h6 mt-4 text-secondary text-dark">
                ...
                locations with DUAL Exchange Homing.
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  Multiple data centre locations, allows access to your website
                  anytime, anywhere. Improved operational efficiencies, Reduced
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  ...
                  document management(SharePoint), Interactive and transactional
                  applications such as VMware VDI, and SQL.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  ...
                  Palo Alto / Checkpoint / Fortinet Firewall, DDOS Protection.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="h2 NunitoSans-ExtraBold col-12 text-center">
              ...
              SIP Connectivity Services?
            </div>
            <div className="h6 col-12 mt-2 text-secondary text-center">
              BGUS SIP Connectivity Services are affordable and dynamically
              priced.
            </div>
