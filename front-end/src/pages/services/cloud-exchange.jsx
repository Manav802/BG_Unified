...
function main(props) {
    return (
        <div>
            <Head>
                <title>
                    The cloud service at its best | Cloud Exchange Connectivity
                    as a Service - BG Unified Solutions
                </title>
            </Head>
                        ...
                        <div className="col-lg-8 offset-lg-2 text-center justify-content-center">
                            ...
                            <Fade duration={700} delay={500} bottom>
                                ...
                                >
                                    ...
                                    Advanced Solution provides private,
                                    seamless, and on-demand connections to many
                                    clouds as well as networks.
                                </p>
                            </Fade>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-10 text-center offset-lg-1">
                            ...
                            <div className="h6 mt-4 text-secondary text-justify text-dark">
                                Cloud Exchange Connectivity as a Service is a
                                fully managed service that allows organizations
                                or firms to set up a secure connection to cloud
                                platforms and services or cloud providers
                                without depending upon internet connectivity.
                                The traffic is not sent over the internet only,
                                rather than the exchange provider connects the
                                exchange’s network directly to the cloud
                                provider’s network.
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="card h-100 rounded-8">
                                    <div className="card-body d-flex flex-column align-items-center">
                                        ...
                                        <div className="text-secondary px-4 text-justify NunitoSans-Regular">
                                            Complete security on our end, while
                                            connecting to these cloud platforms.
                            ...
                            <Fade duration={500} distance={"30%"} bottom>
                                <div className="card h-100 rounded-8">
                                    <div className="card-body d-flex flex-column align-items-center">
                                        ...
                                        <div className="text-secondary px-4 text-justify NunitoSans-Regular">
                                            Traffic increased or decreased is
                                            handled with no difficulty at all.
                                            Avoiding vendor lock-in and meeting
                                            data-sovereignty requirements.
                                            Geo-redundant for improved
                                            performance.
                                        </div>
                                        <Image
                                            className="mt-auto"
                            ...
                            <Fade duration={500} distance={"30%"} bottom>
                                <div className="card h-100 rounded-8">
                                    <div className="card-body d-flex flex-column align-items-center">
                                        ...
                                        <div className="text-secondary px-4 text-justify NunitoSans-Regular">
                                            Simplified usage and integration of
                                            new technology services. On-demand
                                            communication and connectivity.
                                            Multi-cloud operations with a
                        ...
                        <div className="row">
                            <div className="col-12">
                                <p className="lead text-justify">
                                    With BG Unified Solutions Cloud Exchange
                                    Connectivity as a Service, you get Express
                                    Routes to office 365, AWS, Azure. Advanced
                                    Solution provides private, seamless, and
                                    on-demand connections to many clouds as well
                                    as networks. We ensure reliability,
                                    integrity, security as well as scalability
                                    for our cloud exchange connectivity
                                    solutions. Have DC locations including
                                    Equinix SY3, SY4. Determines quality of
                                    service level delivered against service
                                    level agreements and proactively manages
                                    service components to adhere to quality
                                    standards as per customer service
                                    contracts.We give you the power to easily
                                    deploy, efficiently monitor, and
