          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 mt-5 text-center py-5">
                <div className="display2 text-white">Proxy As A Service</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-10 text-center offset-lg-1">
              <div className="h4 NunitoSans-ExtraBold">
                {" "}
                With assured low latency and high availability.
              </div>
              <div className="h6 mt-4 text-secondary text-dark">
                It is a cost-effective way to make your applications and
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                <div className="h5 NunitoSans-Bold text-dark">Firewall</div>
                <p className="text-secondary mt-3">
                  ...
                  Policy Management using Panorama, Sourcefire DC
                </p>
              </div>
            </div>
          </div>
          <div className="flex-lg-row-reverse row mt-5 mt-lg-0">
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  Multiple IP types globally, in a clustered or isolated
                  environment. Enhanced proxy service by isolating the private
                  network from the web, thus allowing limiting access of private
                  network users to Internet-based resources.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row mt-5 mt-lg-0">
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  Use proxy servers at a faster speed and limiting the bandwidth
                  utilization, by filtering traffic, caching files and web pages
                  accessed. Highly advanced, available and multiple data centre
                  locations.
                </p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row">
            <div className="h2 NunitoSans-ExtraBold col-12 text-center">
              Ready to try out our <br className="d-none d-md-block" /> Proxy
              Server Services?
            </div>
