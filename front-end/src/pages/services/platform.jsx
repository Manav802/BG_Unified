...
function Platform(props) {
  return (
    <div>
      <Head>
        <title>Cloud Platform As A Service</title>
      </Head>
          ...
          <div className="row">
            <div className="col-lg-5 p-5">
              <img
                ...
                src="/assets/images/Illustrations/Services/StorageBlocks/RealTimeMonitoring.svg"
                alt=""
              />
            </div>
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  ...
                  innovative, flexible load balancing. Platform-oriented cloud
                  platforms.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  ...
                  infrastructure. Platform-oriented cloud platforms obtains a
          ...
          <div className="row">
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  Scale up your project on demand by purchasing just the amount
                  of hardware or storage you require at affordable prices.
                  Platform as a service cloud providing you with limitless
