              ...
              <div className="px-4 py-5 border">
                ...
                <div className="row px-3">
                  ...
                  <div className="col-lg-5 mt-4">
                    <div className="h6">
                      Specify your choice of no. of Restore Points?
                    </div>
                    <Select
                  ...
                  <div className="col-lg-5 offset-lg-1 mt-4">
                    <div className="h6">
                      Set no. of Geo Locations for your Backups?
                    </div>
                    <Select
                  ...
                  <div className="col-lg-12 mt-3 d-flex justify-content-between">
                    <Flex py="12px" justify="center" align="center">
                      <Switch
                        ...
                        id="hourly-backup"
                      />
                      <FormLabel mb={0} ml="12px" htmlFor="hourly-backup">
                        Hourly Backups
                      </FormLabel>
                    </Flex>
                    <PricingQuote
          ...
          <div className="row">
            <div className="col-lg-10 text-center offset-lg-1">
              ...
              <div className="h6 mt-4 text-secondary text-justify text-dark">
                In today’s dynamic and complex landscape, no one can afford to
                be idle. Whether we like it or not, data centre change is upon
                us. Migrating us to store confidential and information data
                somewhere else, for the worst-case scenarios. And with this
                change comes steep challenges—to migrate your legacy production
                application environments to next-general data centres and enable
                ...
                <div className="card h-100 rounded-8">
                  <div className="card-body d-flex flex-column align-items-center">
                    ...
                    <div className="text-secondary px-4 text-justify NunitoSans-Regular">
                      For any of your organization department, our BaaS offering
                      provides a simplified IT management and a highly scalable
                      platform. Irrespective of the end-user, everyone gets to
                      access to the latest and the greatest backup technology
                      stack. Customized and tailor solutions to meet client
                      needs with Local end-market support services and Local
              ...
              <Fade duration={500} distance={"30%"} bottom>
                <div className="card h-100 rounded-8">
                  <div className="card-body d-flex flex-column align-items-center">
                    ...
                    <div className="text-secondary px-4 text-justify NunitoSans-Regular">
                      Geographically sound, redundant, quick and efficient
                      increasing your backup by 60%. Highly advanced, available
                      and multiple data centre locations offering multiple IP
                      types globally, in a clustered or isolated environment.
                    </div>
                    <Image
          ...
          <div className="row">
            <div className="col-12 p-5 rounded-8 bg-light">
              ...
              <p className="text-justify">
                Through our dedicated Data Center Practice, we can help you
                choose the best path to embrace this transformation at all
                levels—from your base infrastructure to achieve your strategic
                vision and goals. We’ll create a realistic roadmap and provide
                continual service so you can capture the promise of tomorrow’s
                data centre, cloud and backup—today. BG Unified Solution
                provides reliable, secure & cost-effective managed service for
                backup and recovery of all types of data. We handle protection
                and management for all of your structured and unstructured data
                while enabling self-service restoration capability to your
                teams.BG Unified Solutions has the deep technology skills and
                proven methodologies to help you leverage leading data center
                solutions. From legacy production systems support to a wide
                technology lens and multi-vendor solutions, we can help you
                implement a flexible, agile architecture designed specifically
                to meet your unique needs. We bring a broad perspective based on
                demonstrated experience working with many customers in varied
                environments.
              </p>
            </div>
          </div>
