          ...
          <div className="row">
            <div className="col-lg-10 text-center offset-lg-1">
              ...
              <div className="h6 mt-4 text-secondary text-justify text-dark">
                ...
                and streamlining resources of an organisation and increase
              ...
              <Fade duration={500} distance={"30%"} bottom>
                <div className="card h-100 rounded-8">
                  <div className="card-body d-flex flex-column align-items-center">
                    ...
                    <Image
                      height="300px"
                      src="/assets/images/illustrations/Wireless/clusteringOfDevices.svg"
                    ></Image>
                  </div>
                </div>
              </Fade>
              ...
              <Fade duration={500} distance={"30%"} bottom>
                <div className="card h-100 rounded-8">
                  <div className="card-body d-flex flex-column align-items-center">
                    ...
                    <Image
                      height="300px"
                      src="/assets/images/illustrations/Wireless/unified_and_efficient.svg"
                    ></Image>
                  </div>
                </div>
              </Fade>
              ...
              <Fade duration={500} distance={"30%"} bottom>
                <div className="card h-100 rounded-8">
                  <div className="card-body d-flex flex-column align-items-center">
                    ...
                    <Image
                      src="/assets/images/illustrations/Wireless/data_protection.svg"
                      className="mt-auto"
                      height="250px"
                    ></Image>
                  </div>
