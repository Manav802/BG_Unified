            ...
            <div className="row">
              <div className="col-lg-12 mt-5 text-center py-5">
                <div className="display2 text-white">
                  Cloud Logging As A Service(CLaaS)
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-10 text-center offset-lg-1">
              <div className="h4 NunitoSans-ExtraBold">
                Log central services over the internet. Collect, Store, and
                report the various data and underlying threats.{" "}
              </div>
              <div className="h6 mt-4 text-secondary text-dark">
                {" "}
                Add the shield to protect your business reputation. Application
                and system logs ingestions.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                <div className="h5 NunitoSans-Bold text-dark">Completeness</div>
                <p className="text-secondary mt-3">
                  {" "}
                  Fully integrated service performing at scale, can ingest
                  system log data from multiple VMs. Reduction in need for
                  on-site storage. Download archives on-demand.
                </p>
              </div>
            </div>
          </div>
          <div className="flex-lg-row-reverse row mt-5 mt-lg-0">
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  Collecting and managing logs from numerous endpoints, servers
                  and cloud-based resources with ease. Management and monitoring
                  your logs and queries live.{" "}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row mt-5 mt-lg-0">
            ...
            <div className="col-lg-7 d-flex align-items-center px-5">
              <div>
                ...
                <p className="text-secondary mt-3">
                  Dynamic field explorer enhancing your troubleshooting
                  experience. Easy troubleshooting in advanced and modern
                  environments, with appropriate tools and resources.
                </p>
              </div>
            </div>
          </div>
