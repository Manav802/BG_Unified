                ...
                <Head>
                    ...
                    <div className="section">
                        ...
                        <div className="row"> 
                                ...
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>Cloud Platform <br /> service </div>} iconBg="#19C741" children="End-to-End DC network infrastructure encompassing server switching, storage switching, and DC Interconnect Solutions. Huawei 10G core switching offering a high-speed spine and leaf network." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>Firewall <br /> Services </div>} iconBg="#F33022" children="Multi-Layered Hosted Firewall Solution with Dedicated / Shared Firewall using Palo Alto, Fortinet, and Cisco ASA. Centralized Policy Management using Panorama, Sourcefire DC." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>UCaaS (Unified <br /> Communications)</div>} iconBg="#0D5EA5" children="Cisco and Avaya Unified Collaboration, Messaging, Telepresence, Contact Center, Workforce Optimization and Quality Monitoring. N+N Redundant components fulfilling all Unified Collaboration requirements of your business." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>Disaster Recovery <br /> Management </div>} iconBg="#19C741" children="Assist in DR strategy, evaluate threat models, select technologies, prototype multisite or multi-cloud DR strategies. Test rollback mechanisms and measure robustness using failure driven tests." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>Wireless <br /> Networks </div>} iconBg="#F33022" children="Cisco Wi-Fi and Aruba Wi-Fi. The hosted wireless solution includes multiple clusters of Cisco WLC 5508, 2504 and Aruba controllers." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>Customer Support <br /> as a service </div>} iconBg="#0D5EA5" children="Lorem ipsum kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet dolor sit amet, consetetur sadipscing elitr." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>SIP<br /> Connectivity </div>} iconBg="#19C741" children="SIP As A Service Infrastructure includes more than 15 Cisco Unified Border Elements with 1600 SIP channels spanned across multiple DC locations with DUAL Exchange Homing." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>SD-WAN <br /> Optimization </div>} iconBg="#F33022" children="Next-generation WAN connectivity services. We have Express Routes to office 365, AWS, Azure through Equinix Cloud Exchange and are peering with ASNs directly for providing better and high-performance routes to Office 365, Azure and AWS." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>Architectural <br /> Consultancy </div>} iconBg="#0D5EA5" children="Lorem ipsum kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet dolor sit amet, consetetur sadipscing elitr." />
                                </div>
                                <div className="col-lg-4  py-2">
                                    <CardWithIcon icon="/assets/images/icons/monotone/server.svg" title={<div>Application Development <br /> and Scalability </div>} iconBg="#19C741" children="Lorem ipsum kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet dolor sit amet, consetetur sadipscing elitr." />
                                </div>
                                <div className="col-lg-4  py-2">
