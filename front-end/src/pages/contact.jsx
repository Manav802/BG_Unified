                    ...
                    <div className="row centered-content">
                        <div className="col-lg-5 mb-5 contact-info">
                            <div className="row p-3">
                                <div className="col-2 p-0 phone-em"><img src="/assets/images/vectors/phone.png" alt="phone" /></div>
                            ...
                            <div className="row p-3">
                                <div className="col-2 p-0 mail-em"><img src="/assets/images/vectors/mail.png" alt="mail" /></div>
                                <div className="col-10">
                                    <div>Email us</div>
