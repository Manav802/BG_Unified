...
function Blogs() {
  ...
  )); //Formating content according to line breaks
          ...
          <div className="container p-0">
            <div className="py-5 mt-5 row">
              <div className="col-12">
                <div className="rounded-8 cover-image shadow-lg">
                  <Image
                    ...
                    src={
                      blog.image ||
                      "https://source.unsplash.com/1600x900/?IT,technology"
                    }
                  ></Image>
                </div>
              </div>
              ...
              <div className="col-lg-8 mt-3">
                <div className="content-lead">{content}</div>
              </div>
              <div className="col-lg-4 px-4 mt-3">
                ...
                <div className="py-2">
                  <Link href="/blogs/3-bg-unified-solutions-got-nominated-for-two-awards-under-service-and-collaboration-within-revenue-nsw">
                    <a>
                      BG Unified Solutions got nominated for two awards under
                      Service and Collaboration within Revenue NSW
                    </a>
                  </Link>
                </div>
                <div className="py-2">
                  <Link href="/blogs/5-cisco-asa-5520-to-5525x-with-firepower-services">
                    <a>Cisco ASA 5520 to 5525X with FirePower Services</a>
                  </Link>
                </div>
              </div>
            </div>
