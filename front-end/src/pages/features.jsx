    ...
    <div className="features overflow-hidden">
        ...
        <div className="row p-3 p-md-0">
          <div className="col-md-7 pl-0 position-relative d-none d-md-block">
            <Image
              ...
              src="/assets/images/features/vectors/data_protection.png"
            />
          </div>
          <div className="col-md-5 mt-lg-5 align-self-center">
            <div className="display5">
              <span className="badge badge-pill my-2 badge-danger">2</span>{" "}
              <br />
      ...
      <div className="container my-lg-5 py-lg-5 my-md-4 py-md-4 pt-2 mt-2">
        <div className="row p-3 p-md-0">
          ...
          <div className="col-md-5 mt-lg-5 align-self-center">
            <div className="display5 ">
              <span className="badge badge-pill my-2 badge-danger">4</span>{" "}
              <br />
      ...
      <div className="container my-lg-5 py-lg-5 my-md-4 py-md-4 pt-2 mt-2">
        <div className="row no-gutters p-3">
          <div className="col-md-5 align-self-center">
            <div className="display5">
              <span className="badge badge-pill my-2 badge-danger">5</span>{" "}
              <br />
              Data Centre Networking
            </div>
            <p
              className="NunitoSans-SemiBold mt-1 pr-lg-3"
              style={({ fontsize: "20px" }, { opacity: 0.8 })}
            >
          ...
          <div className="col mt-lg-5 pt-lg-0 mt-5 pt-5 d-none d-md-block">
            <Image
              ...
              src="/assets/images/features/vectors/end_to_end.svg"
            />
          </div>
        </div>
      </div>
